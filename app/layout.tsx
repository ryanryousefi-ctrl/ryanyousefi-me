...
export const metadata: Metadata = {
  ...
  description:
    "Ryan Yousefi is an award-winning journalist, editor, and communications executive whose work has appeared in Sports Illustrated, Miami New Times, Bleacher Report, USA Today, Yahoo! Sports, MSN, UPROXX, and multiple Talk Media publications.",
  keywords: [
    "Ryan Yousefi",
    "journalist",
    "editor",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "Award-winning journalist, editor, and communications executive with work in Sports Illustrated, Miami New Times, Bleacher Report, USA Today, Yahoo! Sports, MSN, UPROXX, and multiple Talk Media publications.",
